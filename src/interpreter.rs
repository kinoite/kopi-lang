...
impl Interpreter {
    pub fn new() -> Self {
        ...
        // --- ADD THESE LINES TO REGISTER NEW MODULES ---
        available_modules.insert("string".to_string(), stdlib::create_string_module());
        available_modules.insert("math".to_string(), stdlib::create_math_module());
        available_modules.insert("array".to_string(), stdlib::create_array_module());
        available_modules.insert("md".to_string(), stdlib::create_md_module());
        available_modules.insert("koptui".to_string(), stdlib::create_koptui_module());
        // ------------------------------------------------
    ...
    fn load_builtins(&mut self) {
        ...
        // --- ADD THESE LINES TO REGISTER GLOBAL BUILT-IN FUNCTIONS ---
        self.environment.insert("is_number".to_string(), KopiValue::new_native_fn("is_number", stdlib::is_number));
        self.environment.insert("is_string".to_string(), KopiValue::new_native_fn("is_string", stdlib::is_string));
        self.environment.insert("is_boolean".to_string(), KopiValue::new_native_fn("is_boolean", stdlib::is_boolean));
        self.environment.insert("is_array".to_string(), KopiValue::new_native_fn("is_array", stdlib::is_array));
        self.environment.insert("is_nil".to_string(), KopiValue::new_native_fn("is_nil", stdlib::is_nil));
        // -----------------------------------------------------------
    }
